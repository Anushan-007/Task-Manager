...
onCancel() {
  ...
  constructor(private fb:FormBuilder , private userService: UserService, private router:Router, private toastr:ToastrService, private ActivateService:ActivatedRoute){
  ...
  onSubmit(){
    if (this.isEditForm  == false) {
      ...
      console.log("Edit");
        ...
        this.userService.updateUser(user, this.currentUser.id).subscribe(data => {
